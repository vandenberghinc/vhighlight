...
const now = Date.now();
const tokens = vhighlight.cpp.tokenize({code: new vlib.Path("/Volumes/persistance/private/vinc/vdocs/dev/.old/backend/user/projects.h").load_sync({encoding: "utf8"})});
console.log(tokens);
