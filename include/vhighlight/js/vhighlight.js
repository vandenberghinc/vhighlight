...
"{","}","[","]","(",")","<",">",",","=",].concat(this.scope_separators);this.excluded_word_boundary_joinings=this.excluded_word_boundary_joinings.reduce((accumulator,val)=>{if(!accumulator.includes(val)){
